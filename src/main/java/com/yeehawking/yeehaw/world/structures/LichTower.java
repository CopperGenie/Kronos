...
public class LichTower extends Structure<NoFeatureConfig> {
    public LichTower(Codec<NoFeatureConfig> codec) {
        super(codec);
    }

    private static final List<MobSpawnInfo.Spawners> STRUCTURE_MONSTERS = ImmutableList.of(
            new MobSpawnInfo.Spawners(EntityType.ZOMBIE, 100, 5, 10)
    );
    @Override
        ...
        public void func_230364_a_(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.getRegistry(Registry.JIGSAW_POOL_KEY)
                            ...
                            .getOrDefault(new ResourceLocation(Yeehaw.MOD_ID, "lich_tower")),
            ...
            Yeehaw.LOGGER.log(Level.DEBUG, "Lich Tower at " +
