...
public class DrowChestplate extends ArmorItem {
    public DrowChestplate() {
        super(ModArmorMaterial.UNDERSTEEL, EquipmentSlotType.CHEST, new Properties().group(Yeehaw.COMBAT_TAB));
    }
