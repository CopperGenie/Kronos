...
public class FlayerRobeBottom extends ArmorItem {
    public FlayerRobeBottom() {
        super(ModArmorMaterial.FLAYER, EquipmentSlotType.LEGS, new Item.Properties().group(Yeehaw.COMBAT_TAB));
    }
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(this.text1().mergeStyle(TextFormatting.BLUE));
        tooltip.add(this.text2().mergeStyle(TextFormatting.YELLOW));
    }
    // References en_us
    @OnlyIn(Dist.CLIENT)
