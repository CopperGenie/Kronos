...
public class FlayerRobeTop extends ArmorItem {
    public FlayerRobeTop() {
        super(ModArmorMaterial.FLAYER, EquipmentSlotType.CHEST, new Item.Properties().group(Yeehaw.COMBAT_TAB));
    }
