...
public class TitanLeggings extends ArmorItem {
    public TitanLeggings() {
        super(ModArmorMaterial.TITAN, EquipmentSlotType.LEGS, new Properties().group(Yeehaw.COMBAT_TAB));
    }
