...
public class FlyingCarModel<T extends x0026gEntity> extends EntityModel<T> {
    ...
    public FlyingCarModel() {
        ...
        nyoom.setTextureOffset(0, 18).addBox(-10.5F, -16.0F, -27.0F, 21.0F, 3.0F, 2.0F, 0.0F, false);
