...
public class GnomeElderEntity extends MonsterEntity {

    public GnomeElderEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public static AttributeModifierMap.MutableAttribute setCustomAttributes() {
        return MobEntity.registerAttributes()
                ...
                .createMutableAttribute(Attributes.ATTACK_KNOCKBACK, 300.0f)
    ...
    protected int getExperiencePoints(PlayerEntity player) {
        return 15 + this.world.rand.nextInt(4);
    }
    ...
    public void livingTick() {
        this.i++;
        if (this.i == 20 * 60) {
            this.getEntityWorld().playSound(this.getEntityWorld().getClosestPlayer(this, 7), this.getPosition(), SoundEvents.ENTITY_EVOKER_PREPARE_WOLOLO, SoundCategory.HOSTILE, 0.8F, 0.8F);
            this.i = 0;
        }
        super.livingTick();
    }
