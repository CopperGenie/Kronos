...
public class ToadkinEntity extends AnimalEntity {

    public static final Ingredient TEMPTATION_ITEMS = Ingredient.fromItems(Items.RED_MUSHROOM, Items.BROWN_MUSHROOM);

    public ToadkinEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(6, new LookAtGoal(this, ToadkinEntity.class, 3.0f));
