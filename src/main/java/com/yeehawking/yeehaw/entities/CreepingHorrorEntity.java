...
public class CreepingHorrorEntity extends MonsterEntity {

    public CreepingHorrorEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public static AttributeModifierMap.MutableAttribute setCustomAttributes() {
        return MobEntity.registerAttributes()
                ...
                .createMutableAttribute(Attributes.ATTACK_KNOCKBACK, 0.6f)
                .createMutableAttribute(Attributes.ATTACK_SPEED, 0.20f);
    }
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(7, new LookAtGoal(this, PlayerEntity.class, 30.0F));
    ...
    public boolean attackEntityAsMob(Entity entityIn) {
        ...
        if (flag && entityIn instanceof LivingEntity && rand.nextInt(2) == 0) {
            ...
            ((LivingEntity)entityIn).addPotionEffect(new EffectInstance(Effects.POISON, 100 * (int)f, 0, false, false));
        }
        if (flag && entityIn instanceof LivingEntity) {
            float f = this.world.getDifficultyForLocation(this.getPosition()).getAdditionalDifficulty();
            ((LivingEntity)entityIn).addPotionEffect(new EffectInstance(Effects.SLOWNESS, 100 * (int)f, 0, false, false));
        }
